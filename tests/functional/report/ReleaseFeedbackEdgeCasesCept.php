...
$I->wantTo('Test out the case where someone tries to release an exams which has no graded students');
$I->sendAjaxPostRequest("report/{$examWithNoGradedId}/release");
$I->seeResponseCodeIs(200);

$I->wantTo('Test out the case where someone tries to release an exams which has no questions');
