...
//    BootboxModals::waitForBootboxModal($I, true, true);
    $I->wait(5);
//$I->waitForElementNotVisible(['css' => '.' . ReportIndexPage::$releaseTextClass]);
...
//    $I->see(ReportIndexPage::$releaseSuccessText);
...
$I->amGoingTo("Make sure that errors are properly handled when try to release an exam without questions or graded students");
