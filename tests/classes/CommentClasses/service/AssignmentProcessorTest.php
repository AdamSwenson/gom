...
class AssignmentProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->factory = new \CommentClasses\dao\IAssignmentFactoryMock();
        $this->exam = new \Exam();
    ...
    public function testLoad_factory()
    {
        ...
        $this->assertAttributeInstanceOf('\CommentClasses\dao\IAssignmentFactory', 'factory', $this->object);
    }
...
//        $this->object->load_factory($this->factory);
//        $this->object->load_cleaner(new \SecurityClasses\cleaning\CleanerFactory());
