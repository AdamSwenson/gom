...
class StockTextProcessorTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp()
    {
        ...
        $this->handler = new \JsonOutputClasses\controllers\IResponseChooserMock();
        $this->dao = new \CommentClasses\dao\IStockTextDaoMock();
    }
    ...
    {
        foreach (\CommentClasses\dao\StockTextDao::$valences as $valence) {
