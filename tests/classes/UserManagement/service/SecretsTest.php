...
class SecretsTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('\UserManagement\service\SecretsParent', $this->object);
    ...
    {
        $this->object = Secrets::factory(\UserManagement\service\Secrets::USER);
        $this->assertInstanceOf('\UserManagement\service\UserSecrets', $this->object);
    }

    public function testFactoryOverriderTest()
    {
        $this->object = Secrets::factory(\UserManagement\service\Secrets::TEST);
        $this->assertInstanceOf('\UserManagement\service\TestingSecrets', $this->object);
    }

//    public function testFactoryOverrideLive()
//    {
//        $this->object = Secrets::factory(\UserManagement\service\Secrets::NORMAL);
//        $this->assertInstanceOf('\UserManagement\service\LiveSecrets', $this->object);
//    }
