...
class QuestionAssignerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->questiondao = new \QuestionClasses\dao\IQuestionDAOMock();
        $this->assignerdao = new \QuestionClasses\dao\IQuestionAssignmentDAOMock();
    ...
    public function testSet_question_assigner_dao()
    {
        ...
        $this->assertAttributeInstanceOf('\QuestionClasses\dao\IQuestionAssignmentDAO', 'question_assigner_dao', $this->object);
    }

    public function testSet_question_dao()
    {
        $this->object->set_question_dao($this->questiondao);
        $this->assertAttributeInstanceOf('\QuestionClasses\dao\IQuestionDAO', 'question_dao', $this->object);
    }

    /**
     * @covers \QuestionClasses\service\QuestionAssigner::record
     */
