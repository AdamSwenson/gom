...
class NonceValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->logger = new \SecurityClasses\logging\ISecurityLoggersMock();
    }
    ...
    /**
     * @covers SecurityClasses\nonces\NonceValidator::set_logger
     */
    public function testSet_logger()
    {
        $this->object->set_logger($this->logger);
        $this->assertAttributeInstanceOf('\SecurityClasses\logging\ISecurityLoggers', 'logger', $this->object);
    }
