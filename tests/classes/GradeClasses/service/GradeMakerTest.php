...
//        $this->object = new GradeMaker;
    ...
    public function testCalculated()
    {
        ...
        $this->assertInstanceOf('GradeClasses\models\CalculatedGrade', $this->object);
    }
    ...
    public function testCalculatedArgs()
    {
        ...
        $this->object = GradeMaker::factory(GradeMaker::CALCULATED,
            $this->displayText,
            $this->displayNumeric,
            array(\GradeClasses\models\CalculatedGrade::MAX_SCORE_KEY => $max,
            \GradeClasses\models\CalculatedGrade::MIN_SCORE_KEY => $min)
        );
        $this->assertInstanceOf('GradeClasses\models\CalculatedGrade', $this->object);
        $this->assertAttributeInstanceOf('GradeClasses\models\Grade', 'grade', $this->object);
    ...
    public function testDirect()
    {
        ...
        $this->assertInstanceOf('GradeClasses\models\DirectlyAssigned', $this->object);
    }
