...
class ExamCreatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    function setUp()
    {
        ...
        $this->restrictordao = new \RestrictorClasses\dao\IRestrictorDAOMock();
    ...
    public function testLoad_restrictor_dao()
    {
        ...
        $this->assertAttributeInstanceOf('\RestrictorClasses\dao\IRestrictorDAO', 'restrictor_dao', $this->object);
    }
