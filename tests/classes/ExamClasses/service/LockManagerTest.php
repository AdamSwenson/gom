...
public $request;
    ...
    /**
     * @covers \ExamClasses\service\LockManager::execute
     */
    public function testExecute_lock()
    {
        $this->request->http = array('task' => \ExamClasses\service\LockManager::LOCK_TASK, \ExamClasses\service\LockManager::LOCK_KEY => 5);
    ...
    {
        $this->request->http = array('task' => \ExamClasses\service\LockManager::UNLOCK_TASK, \ExamClasses\service\LockManager::UNLOCK_KEY => 5);
