 ...
 *
 * @method     \ExamQuery|\QuestionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class QuestionAssignerQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT examID, questionNumber, questionID, created_at, updated_at FROM questionAssigner WHERE examID = :p0 AND questionNumber = :p1';
        try {
