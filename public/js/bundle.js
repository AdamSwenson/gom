...
var grades = [{ label: 'A', name: 'A', minScore: 0, maxScore: 100 }, { label: 'A-', name: 'Aminus', minScore: 0, maxScore: 100 }, { label: 'B+', name: 'Bplus', minScore: 0, maxScore: 100 }, { label: 'B', name: 'B', minScore: 0, maxScore: 100 }, { label: 'B-', name: 'Bminus', minScore: 0, maxScore: 100 }, { label: 'C+', name: 'Cplus', minScore: 0, maxScore: 100 }, { label: 'C', name: 'C', minScore: 0, maxScore: 100 }, { label: 'C-', name: 'Cminus', minScore: 0, maxScore: 100 }, { label: 'D+', name: 'Dplus', minScore: 0, maxScore: 100 }, { label: 'D', name: 'D', minScore: 0, maxScore: 100 }, { label: 'D-', name: 'Dminus', minScore: 0, maxScore: 100 }, { label: 'F', name: 'F', minScore: 0, maxScore: 100 }];
...
Vue.component('grade-slider', {
    ...
    methods: {
        ...
        //    this.$set();
        //}
        updateMaxScore: function updateMaxScore(v) {
            this.maxScore = v;
        },
        updateMinScore: function updateMinScore(v) {
...
new Vue({
    ...
    data: {
        ...
        minScore: 0,
        maxScore: 50,
        grades: [{ label: 'A', name: 'A', order: 0 }, { label: 'A-', name: 'Aminus', order: 1 }, { label: 'B+', name: 'Bplus', order: 2 }, { label: 'B', name: 'B', order: 3 }, { label: 'B-', name: 'Bminus', order: 4 }, { label: 'C+', name: 'Cplus', order: 5 }, { label: 'C', name: 'C', order: 6 }, { label: 'C-', name: 'Cminus', order: 7 }, { label: 'D+', name: 'Dplus', order: 8 }, { label: 'D', name: 'D', order: 9 }, { label: 'D-', name: 'Dminus', order: 10 }, { label: 'F', name: 'F', order: 11 }]

    },

    methods: {
        updateSlider: function updateSlider($event) {
