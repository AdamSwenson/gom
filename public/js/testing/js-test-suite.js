...
var input=document.createElement("input"),div=document.createElement("div"),fragment=document.createDocumentFragment(); // AsyncStorage
...
// If the og has innerHTML and the destination does not,
// copy the og.innerHTML into the dest.innerHTML. #10324
...
var div,style,a,pixelPositionVal,boxSizingReliableVal,reliableHiddenOffsetsVal,reliableMarginRightVal; // AsyncStorage
...
var input,div,select,a,opt; // AsyncStorage
...
// http://msdn.microsoft.com/en-us/library/ms536429%28VS.85%29.aspx
if(!support.hrefNormalized){ // href/og property should get the full normalized URL (#10299/#12915)
...
factory(jQuery);}})(function($){ /*!
     ...
     */ // $.ui might exist from components_help with no dependencies, e.g., $.ui.position
...
// https://code.google.com/p/maashaack/source/browse/packages/graphics/trunk/og/graphics/colors/HUE2RGB.as?r=5021
