...
module.exports = {
    ...
    props: ['exam-id', 'released', 'graded', 'previously-released'],
    ...
    computed: {
         ...
         * @returns {*}
         */
        priorRelease: function priorRelease() {
    ...
    methods: {
         ...
         */
        handleCanceledRelease: function handleCanceledRelease() {
         ...
         */
        sendReleaseExamEvent: function sendReleaseExamEvent() {
         ...
         */
        sendHideExamEvent: function sendHideExamEvent() {
        ...
        handleSuccessfulHide: function handleSuccessfulHide() {
        ...
        handleErrorOnRelease: function handleErrorOnRelease() {
            //notify of error
        ...
        handleErrorOnHide: function handleErrorOnHide() {
            //notify of error
    ...
    events: {
        'exam-release-success': function examReleaseSuccess(examId) {
