...
new Vue({
    ...
    events: {
        'student-select-event': function studentSelectEvent(studentId) {
...
},{"./components/elementInput.js":18,"bootstrap":2,"jquery":15,"vue":17}],2:[function(require,module,exports){
...
module.exports = {
    ...
    props: ['elementNumber', 'elementIndex', 'elementId', 'elementName', 'questionNumber'],
    ...
    computed: {
         ...
         * @returns {string}
         */
        commentAreaId: function commentAreaId() {
         ...
         * @returns {string}
         */
        elementTitle: function elementTitle() {
    ...
    methods: {
         ...
         * @param slideEvent
         */
        notifySlideEvent: function notifySlideEvent(slideEvent) {
...
},{"../../libraries/bootstrap-slider-modified.js":20,"../templates/element-input.template.html":19,"jquery":15}],19:[function(require,module,exports){
