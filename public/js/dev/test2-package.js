...
var Comment = function (_IModel) {
    _inherits(Comment, _IModel);
...
var getActiveStudentGradingTime = exports.getActiveStudentGradingTime = 'getActiveStudentGradingTime';
...
var mutations = (_mutations = {}, _defineProperty(_mutations, mTypes.setActiveExam, function (state, payload) {
    if (_Payload2.default.checkIfPayload(payload) && typeof payload.obj != 'undefined') {
...
var actions = (_actions = {}, _defineProperty(_actions, aTypes.setActiveExam, function (_ref, payload) {
    ...
    if (payload instanceof _Exam2.default) {
        payload = _Payload2.default.factory({ obj: payload });
    }
...
var getters = {
     ...
     * @returns {*}
     */
    getActiveExamObj: function getActiveExamObj(state) {
...
var isElementCommentsEmpty = function isElementCommentsEmpty(state) {
...
var isExamGradeEmpty = function isExamGradeEmpty(state) {
    if (Object.keys(state.examGrades).length > 0) {
        return false;
    }
    return true;
...
var isStandardGradesEmpty = function isStandardGradesEmpty(state) {
    if (Object.keys(state.standardGrades).length > 0) {
        return false;
    }
    return true;
};
...
var isScoresEmpty = function isScoresEmpty(state) {
    if (Object.keys(state.questionScores).length > 0) {
        return false;
    }
    return true;
...
var mutations = (_mutations = {}, _defineProperty(_mutations, mTypes.toggleDeleteButtonVisibility, function (state, payload) {
    state.deleteButtonsVisible = !state.deleteButtonsVisible;
}), _defineProperty(_mutations, mTypes.toggleReorderMode, function (state, payload) {
    state.reorderModeOn = !state.reorderModeOn;
}), _defineProperty(_mutations, mTypes.toggleSampleFeedback, function (state, payload) {
...
var getters = {
    isDeleteVisible: function isDeleteVisible(state, getters) {
        return state.deleteButtonsVisible;
    },

    isReorderModeOn: function isReorderModeOn(state, getters) {
        return state.reorderModeOn;
    },

    isSampleFeedbackVisible: function isSampleFeedbackVisible(state, getters) {
...
var getters = (_getters = {}, _defineProperty(_getters, gTypes.isItemSettingsVisible, function (state, getters, rootState) {
    return function (index) {
...
//settings
var toggleDeleteButtonVisibility = exports.toggleDeleteButtonVisibility = 'toggleDeleteButtonVisibility';
