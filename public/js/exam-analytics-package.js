...
function howToReadBoxPlot() {
    showMessage('<p style="text-align: justify;">How to Read - Box Plot', 'In this graph, each set of question scores is represented by a box with lines. ' + 'The bottom line indicates the lowest quartile (25%) of scores, while the box ' + 'displays the second and third quartiles (25%-75%). The top line shows the range of the top ' + '25% of scores. Additional dots show the mean and median score for the question.</p>');
}
...
},{"../common.js":17,"bootstrap":2,"jquery":16,"jquery-ui":15}],2:[function(require,module,exports){
