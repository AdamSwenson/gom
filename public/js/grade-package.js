...
new Vue({
    ...
    methods: {
        setCurrentStudent: function setCurrentStudent(studentId, studentIdentifier, studentName) {
        ...
        selectStudentToGrade: function selectStudentToGrade(studentId) {
...
},{"./components/grade/currentStudentTemplate.html":69,"./components/grade/elementSliderTemplate.html":70,"./components/grade/numberGradedAndRemainingTemplate.html":71,"./components/grade/questionScoreTemplate.html":72,"./components/grade/statisticsTemplate.html":73,"vue":67}],2:[function(require,module,exports){
...
module.exports = '<div class="col-md-6">\n    <h4 id="student-name" v-show="current-student-name"><span class="glyphicon glyphicon-pencil"> </span> {{ currentStudentName }}</h4>\n</div>\n<div class="col-md-6">\n    <input v-if="student-id" type="hidden" name="studentId" value="{{ studentId }}" />\n    <h4 id="student-id" v-show="current-student-identifier">ID {{ currentStudentIdentifier }} </h4>\n</div>';
},{}],70:[function(require,module,exports){
module.exports = '\n    <li class="list-group-item">\n        <h5>{{ elementName }}</h5>\n        <input type="text" name="el_assign_{{ elementAssignmentId }}" v-model="elementScore" />\n        <input type="range"\n               v-model="elementScore"\n               min="0"\n               max="10"\n               data-slider-min="0"\n               data-slider-max="10"\n               data-slider-step="0.25"\n               data-slider-value="5"\n               data-slider-orientation="horizontal">\n    </li>\n';
},{}],71:[function(require,module,exports){
module.exports = '<p id="gradedRemaining">Graded: {{ numberExamsGraded }} Remaining: {{ numberExamsRemaining }}</p>';
},{}],72:[function(require,module,exports){
module.exports = '<h4>\n    <div class="row">\n        <span class="col-md-4">Input Score: <input type="text" name="q_{{questionNumber}}_score_input" v-model="questionScoreInput" ></span>\n        <span class="col-md-8">Custom Score: <input type="text" name="q_{{questionNumber}}_score_custom" v-model="questionScoreCustom" ></span>\n    </div>\n</h4>';
},{}],73:[function(require,module,exports){
module.exports = '<span class="col-md-6">Time This Exam</span>\n<span class="col-md-6">{{ currentExam | convertTime }}</span>\n\n<span class="col-md-6">Average Time</span>\n<span class="col-md-6">{{ averageExam | convertTime }}</span>\n\n<span class="col-md-6">Total Time</span>\n<span class="col-md-6">{{ totalElapsed | convertTime }}</span>\n\n<span class="col-md-6">Time Remaining</span>\n<span class="col-md-6">{{ totalRemaining | convertTime }}</span>';
},{}]},{},[1]);
