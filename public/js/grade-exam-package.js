...
(function () {
    ...
    var Roster = {
         ...
         */
        setActiveStudentBackgroundColor: function setActiveStudentBackgroundColor(activeStudent) {
            if (activeStudent) {
    ...
    var AjaxHandler = {
         ...
         * @param $comment
         */
        updateAndSaveComment: function updateAndSaveComment($comment, data, Roster) {
         ...
         */
        createGradeRequest: function createGradeRequest(dataType, dataId, score, comment, Roster) {
            var gradeRequest = {};
...
},{"../common.js":17,"../libraries/bootstrap-slider-modified.js":19,"../libraries/typeahead.bundle.js":20,"./letterGradeButton.js":18,"bootbox":2,"bootstrap":3,"jquery":16}],2:[function(require,module,exports){
/**
 * bootbox.js [v4.4.0]
 *
...
},{"./utilities/JiraIssueCollector.js":21,"./utilities/ajaxCsrfPrep.js":22,"./utilities/flashMessageHandling.js":23,"./utilities/navbar.js":24,"jquery":16}],18:[function(require,module,exports){
/**
