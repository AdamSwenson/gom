...
function confirmRelease(examId) {
    ...
    var confirmMsg = "Releasing this exam will e-mail all students \n their grades and personalized feedback. " + "Do you wish to continue?";
    if (released === '1') confirmMsg = "Re-releasing this exam sends all students an additional message informing them " + "that exam grades or comments may have changed. Do you wish to continue?";
...
function removeAccess(examId) {
    bootbox.confirm('Removing access will prevent students from viewing feedback on the exam. Access can ' + 'be restored by releasing the exam again.', function (result) {
        var $exam = $('#exam' + examId);
        $exam.addClass('disabled');
        if (result) {
...
function setAsReleased($exam) {
    ...
    $exam.html("<span class='glyphicon glyphicon-envelope' aria-hidden='true'></span>" + " Released");
}
...
function setAsUnreleased($exam) {
    ...
    $exam.html("<span class='glyphicon glyphicon-envelope' aria-hidden='true'></span>" + " Release Exam");
}
