...
/**
 * Base class that represents a row from the 'tagsXquestions' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class TaggedQuestion implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TaggedQuestionTableMap';
    ...
    /**
     * Initializes internal state of Base\TaggedQuestion object.
     */
    ...
    /**
     * Compares this with another <code>TaggedQuestion</code> instance.  If
     * <code>obj</code> is an instance of <code>TaggedQuestion</code>, delegates to
     * <code>equals(TaggedQuestion)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TaggedQuestion The current object, for fluid interface
     */
     ...
     * @return $this|\TaggedQuestion The current object (for fluent API support)
     */
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[TaggedQuestionTableMap::COL_TAG_ID] = true;
        }
    ...
    public function setQuestionId($v)
    {
        ...
        if ($this->question_id !== $v) {
            $this->question_id = $v;
            $this->modifiedColumns[TaggedQuestionTableMap::COL_QUESTION_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[TaggedQuestionTableMap::COL_USER_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TaggedQuestionTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TaggedQuestionTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TaggedQuestionTableMap::translateFieldName('TagId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TaggedQuestionTableMap::translateFieldName('QuestionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->question_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TaggedQuestionTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TaggedQuestionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TaggedQuestionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = TaggedQuestionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TaggedQuestion'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTaggedQuestionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TaggedQuestion::setDeleted()
     * @see TaggedQuestion::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTaggedQuestionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TaggedQuestionTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(TaggedQuestionTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TaggedQuestionTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                TaggedQuestionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TaggedQuestionTableMap::COL_TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'tag_id';
        }
        if ($this->isColumnModified(TaggedQuestionTableMap::COL_QUESTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'question_id';
        }
        if ($this->isColumnModified(TaggedQuestionTableMap::COL_USER_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO tagsXquestions (%s) VALUES (%s)',
    ...
    {
        $pos = TaggedQuestionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TaggedQuestion'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TaggedQuestion'][$this->hashCode()] = true;
        $keys = TaggedQuestionTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaggedQuestionTableMap::COL_CREATED_AT)) {
            $criteria->add(TaggedQuestionTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(TaggedQuestionTableMap::COL_UPDATED_AT)) {
            $criteria->add(TaggedQuestionTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function hashCode()
    {
        ...
        //relation tagsXquestions_fk_83fc93 to table questions
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TaggedQuestion (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TaggedQuestion Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addTaggedQuestions($this);
             */
        }
    ...
    public function getTag(ConnectionInterface $con = null)
    {
        if ($this->aTag === null && ($this->tag_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTag->addTaggedQuestions($this);
             */
        }
    ...
    public function getQuestion(ConnectionInterface $con = null)
    {
        if ($this->aQuestion === null && ($this->question_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aQuestion->addTaggedQuestions($this);
             */
        }
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeTaggedQuestion($this);
        }
        if (null !== $this->aTag) {
            $this->aTag->removeTaggedQuestion($this);
        }
        if (null !== $this->aQuestion) {
            $this->aQuestion->removeTaggedQuestion($this);
        }
        $this->tag_id = null;
    ...
    {
        return (string) $this->exportTo(TaggedQuestionTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildTaggedQuestion The current object (for fluent API support)
     */
