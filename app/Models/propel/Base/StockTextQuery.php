...
/**
 * Base class that represents a query for the 'stockTexts' table.
 *
 *
 *
 * @method     ChildStockTextQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 *
 * @method     ChildStockTextQuery groupById() Group by the id column
 ...
 *
 * @method     ChildStockText findOneById(int $id) Return the first ChildStockText filtered by the id column
 ...
 * @method     ChildStockText requirePk($key, ConnectionInterface $con = null) Return the ChildStockText by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildStockText requireOne(ConnectionInterface $con = null) Return the first ChildStockText matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildStockText requireOneById(int $id) Return the first ChildStockText filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildStockText[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildStockText objects based on current ModelCriteria
 * @method     ChildStockText[]|ObjectCollection findById(int $id) Return ChildStockText objects filtered by the id column
 ...
 *
 */
abstract class StockTextQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\StockTextQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'gom', $modelName = '\\StockText', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildStockTextQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildStockTextQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildStockTextQuery) {
            return $criteria;
        }
        $query = new ChildStockTextQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildStockText|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = StockTextTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return ChildStockText A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildStockText $obj */
            $obj = new ChildStockText();
            $obj->hydrate($row);
            StockTextTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(StockTextTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(StockTextTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(StockTextTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(StockTextTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StockTextTableMap::COL_ID, $id, $comparison);
    }

    /**
     * Filter the query on the valence column
     *
     * Example usage:
     * <code>
     * $query->filterByValence('fooValue');   // WHERE valence = 'fooValue'
     * $query->filterByValence('%fooValue%'); // WHERE valence LIKE '%fooValue%'
     * </code>
     *
     * @param     string $valence The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildStockTextQuery The current query, for fluid interface
     */
    public function filterByValence($valence = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($valence)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $valence)) {
                $valence = str_replace('*', '%', $valence);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(StockTextTableMap::COL_VALENCE, $valence, $comparison);
    }
    ...
    public function filterByContent($content = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StockTextTableMap::COL_CONTENT, $content, $comparison);
    }
    ...
    public function filterByType($type = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StockTextTableMap::COL_TYPE, $type, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(StockTextTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(StockTextTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StockTextTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(StockTextTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(StockTextTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     *
     * @param   ChildStockText $stockText Object to remove from the list of results
     *
     * @return $this|ChildStockTextQuery The current query, for fluid interface
     */
    public function prune($stockText = null)
    {
        if ($stockText) {
            $this->addUsingAlias(StockTextTableMap::COL_ID, $stockText->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the stockTexts table.
     *
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            StockTextTableMap::clearInstancePool();
            StockTextTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(StockTextTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            StockTextTableMap::removeInstanceFromPool($criteria);
    ...
    {
        return $this->addUsingAlias(StockTextTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(StockTextTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(StockTextTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(StockTextTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(StockTextTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(StockTextTableMap::COL_CREATED_AT);
    }
