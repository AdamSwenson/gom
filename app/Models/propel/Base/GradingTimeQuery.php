...
/**
 * Base class that represents a query for the 'time_grading' table.
 *
 *
 *
 * @method     ChildGradingTimeQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 *
 * @method     ChildGradingTimeQuery groupById() Group by the id column
 ...
 * @method     ChildGradingTimeQuery innerJoinExam($relationAlias = null) Adds a INNER JOIN clause to the query using the Exam relation
 *
 * @method     ChildGradingTimeQuery leftJoinStudent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Student relation
 ...
 *
 * @method     ChildGradingTime findOneById(int $id) Return the first ChildGradingTime filtered by the id column
 ...
 * @method     ChildGradingTime requirePk($key, ConnectionInterface $con = null) Return the ChildGradingTime by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildGradingTime requireOne(ConnectionInterface $con = null) Return the first ChildGradingTime matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildGradingTime requireOneById(int $id) Return the first ChildGradingTime filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildGradingTime[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildGradingTime objects based on current ModelCriteria
 * @method     ChildGradingTime[]|ObjectCollection findById(int $id) Return ChildGradingTime objects filtered by the id column
 ...
 *
 */
abstract class GradingTimeQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\GradingTimeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'gom', $modelName = '\\GradingTime', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildGradingTimeQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildGradingTimeQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildGradingTimeQuery) {
            return $criteria;
        }
        $query = new ChildGradingTimeQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildGradingTime A model object, or null if the key is not found
     */
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GradingTimeTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByExamid($examid = null, $comparison = null)
    {
        if (is_array($examid)) {
            $useMinMax = false;
            if (isset($examid['min'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_EXAMID, $examid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($examid['max'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_EXAMID, $examid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GradingTimeTableMap::COL_EXAMID, $examid, $comparison);
    }
    ...
    public function filterByStudentid($studentid = null, $comparison = null)
    {
        if (is_array($studentid)) {
            ...
            if (isset($studentid['min'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_STUDENTID, $studentid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($studentid['max'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_STUDENTID, $studentid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GradingTimeTableMap::COL_STUDENTID, $studentid, $comparison);
    }
    ...
    public function filterBySeconds($seconds = null, $comparison = null)
    {
        if (is_array($seconds)) {
            ...
            if (isset($seconds['min'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_SECONDS, $seconds['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($seconds['max'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_SECONDS, $seconds['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GradingTimeTableMap::COL_SECONDS, $seconds, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GradingTimeTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(GradingTimeTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByExam($exam, $comparison = null)
    {
        if ($exam instanceof \Exam) {
            return $this
                ->addUsingAlias(GradingTimeTableMap::COL_EXAMID, $exam->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(GradingTimeTableMap::COL_EXAMID, $exam->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByStudent($student, $comparison = null)
    {
        if ($student instanceof \Student) {
            return $this
                ->addUsingAlias(GradingTimeTableMap::COL_STUDENTID, $student->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(GradingTimeTableMap::COL_STUDENTID, $student->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildGradingTime $gradingTime Object to remove from the list of results
     *
     * @return $this|ChildGradingTimeQuery The current query, for fluid interface
     */
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            GradingTimeTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(GradingTimeTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            GradingTimeTableMap::removeInstanceFromPool($criteria);
    ...
    {
        return $this->addUsingAlias(GradingTimeTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(GradingTimeTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(GradingTimeTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(GradingTimeTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(GradingTimeTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(GradingTimeTableMap::COL_CREATED_AT);
    }
