 ...
 *
 *
 * @method     ChildQuestionAssignerQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 *
 * @method     ChildQuestionAssignerQuery groupById() Group by the id column
 ...
 *
 * @method     \ExamQuery|\QuestionQuery|\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildQuestionAssigner findOneById(int $id) Return the first ChildQuestionAssigner filtered by the id column
 ...
 *
 * @method     ChildQuestionAssigner requireOneById(int $id) Return the first ChildQuestionAssigner filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildQuestionAssigner[]|ObjectCollection findById(int $id) Return ChildQuestionAssigner objects filtered by the id column
...
abstract class QuestionAssignerQuery extends ModelCriteria
{
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = QuestionAssignerTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, examID, questionNumber, user_id, questionID, created_at, updated_at FROM questionAssigner WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            QuestionAssignerTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(QuestionAssignerTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(QuestionAssignerTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(QuestionAssignerTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(QuestionAssignerTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(QuestionAssignerTableMap::COL_ID, $id, $comparison);
    }
    ...
    {
        if ($questionAssigner) {
            $this->addUsingAlias(QuestionAssignerTableMap::COL_ID, $questionAssigner->getId(), Criteria::NOT_EQUAL);
        }
