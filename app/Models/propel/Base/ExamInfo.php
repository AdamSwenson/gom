...
/**
 * Base class that represents a row from the 'examInfo' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class ExamInfo implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ExamInfoTableMap';
    ...
    /**
     * The value for the notecard field.
     * @var        double
     */
    protected $notecard;

    /**
     * The value for the examgroupnumber field.
     * @var        int
     */
    protected $examgroupnumber;
    ...
    /**
     * Initializes internal state of Base\ExamInfo object.
     */
    ...
    /**
     * Compares this with another <code>ExamInfo</code> instance.  If
     * <code>obj</code> is an instance of <code>ExamInfo</code>, delegates to
     * <code>equals(ExamInfo)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ExamInfo The current object, for fluid interface
     */
     ...
     * @return int
     */
    public function getCompletionorder()
    {
    ...
    /**
     * Get the [examgroupnumber] column value.
     *
     * @return int
     */
    public function getExamgroupnumber()
    {
    ...
    public function setExamid($v)
    {
        ...
        if ($this->examid !== $v) {
            $this->examid = $v;
            $this->modifiedColumns[ExamInfoTableMap::COL_EXAMID] = true;
        }
    ...
    public function setStudentid($v)
    {
        ...
        if ($this->studentid !== $v) {
            $this->studentid = $v;
            $this->modifiedColumns[ExamInfoTableMap::COL_STUDENTID] = true;
        }
     ...
     * @return $this|\ExamInfo The current object (for fluent API support)
     */
    public function setCompletionorder($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->completionorder !== $v) {
            $this->completionorder = $v;
            $this->modifiedColumns[ExamInfoTableMap::COL_COMPLETIONORDER] = true;
        }
    ...
    public function setPages($v)
    {
        ...
        if ($this->pages !== $v) {
            $this->pages = $v;
            $this->modifiedColumns[ExamInfoTableMap::COL_PAGES] = true;
        }
    ...
    /**
     * Set the value of [notecard] column.
     *
     * @param double $v new value
     * @return $this|\ExamInfo The current object (for fluent API support)
     */
    public function setNotecard($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }
        ...
        if ($this->notecard !== $v) {
            $this->notecard = $v;
            $this->modifiedColumns[ExamInfoTableMap::COL_NOTECARD] = true;
        }
    ...
    /**
     * Set the value of [examgroupnumber] column.
     *
     * @param int $v new value
     * @return $this|\ExamInfo The current object (for fluent API support)
     */
    public function setExamgroupnumber($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->examgroupnumber !== $v) {
            $this->examgroupnumber = $v;
            $this->modifiedColumns[ExamInfoTableMap::COL_EXAMGROUPNUMBER] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ExamInfoTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ExamInfoTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ExamInfoTableMap::translateFieldName('Examid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ExamInfoTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildExamInfoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ExamInfo::setDeleted()
     * @see ExamInfo::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildExamInfoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ExamInfoTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ExamInfoTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ExamInfoTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ExamInfoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExamInfoTableMap::COL_EXAMID)) {
        ...
        if ($this->isColumnModified(ExamInfoTableMap::COL_PAGES)) {
            $modifiedColumns[':p' . $index++]  = 'pages';
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_NOTECARD)) {
            $modifiedColumns[':p' . $index++]  = 'notecard';
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_EXAMGROUPNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'examGroupNumber';
        }
        ...
        $sql = sprintf(
            'INSERT INTO examInfo (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'pages':
                        ...
                        break;
                    case 'notecard':
                        $stmt->bindValue($identifier, $this->notecard, PDO::PARAM_STR);
                        break;
                    case 'examGroupNumber':
                        $stmt->bindValue($identifier, $this->examgroupnumber, PDO::PARAM_INT);
                        break;
                    case 'user_id':
    ...
    {
        $pos = ExamInfoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ExamInfo'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ExamInfo'][$this->hashCode()] = true;
        $keys = ExamInfoTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(ExamInfoTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ExamInfoTableMap::COL_EXAMID)) {
            $criteria->add(ExamInfoTableMap::COL_EXAMID, $this->examid);
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_STUDENTID)) {
        ...
        if ($this->isColumnModified(ExamInfoTableMap::COL_PAGES)) {
            $criteria->add(ExamInfoTableMap::COL_PAGES, $this->pages);
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_NOTECARD)) {
            $criteria->add(ExamInfoTableMap::COL_NOTECARD, $this->notecard);
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_EXAMGROUPNUMBER)) {
            $criteria->add(ExamInfoTableMap::COL_EXAMGROUPNUMBER, $this->examgroupnumber);
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_USER_ID)) {
            $criteria->add(ExamInfoTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_CREATED_AT)) {
            $criteria->add(ExamInfoTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ExamInfoTableMap::COL_UPDATED_AT)) {
            $criteria->add(ExamInfoTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildExamInfoQuery::create();
        $criteria->add(ExamInfoTableMap::COL_EXAMID, $this->examid);
        $criteria->add(ExamInfoTableMap::COL_STUDENTID, $this->studentid);
    ...
    public function hashCode()
    {
        ...
        //relation examInfo_fk_71c1fe to table exams
        ...
        //relation examInfo_fk_175030 to table students
    ...
    {
        return (null === $this->getExamid()) && (null === $this->getStudentid());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ExamInfo (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setExamgroupnumber($this->getExamgroupnumber());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ExamInfo Clone of current object.
     * @throws PropelException
     */
    ...
    public function getStudent(ConnectionInterface $con = null)
    {
        if ($this->aStudent === null && ($this->studentid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStudent->addExamInfos($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aExam) {
            $this->aExam->removeExamInfo($this);
        }
        if (null !== $this->aStudent) {
    ...
    {
        return (string) $this->exportTo(ExamInfoTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildExamInfo The current object (for fluent API support)
     */
