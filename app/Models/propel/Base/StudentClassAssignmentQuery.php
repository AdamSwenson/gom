...
/**
 * Base class that represents a query for the 'studentsXclasses' table.
 *
 *
 *
 ...
 * @method     ChildStudentClassAssignmentQuery innerJoinStudent($relationAlias = null) Adds a INNER JOIN clause to the query using the Student relation
 *
 * @method     ChildStudentClassAssignmentQuery leftJoinKumi($relationAlias = null) Adds a LEFT JOIN clause to the query using the Kumi relation
 ...
 *
 */
abstract class StudentClassAssignmentQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\StudentClassAssignmentQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'gom', $modelName = '\\StudentClassAssignment', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildStudentClassAssignmentQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildStudentClassAssignmentQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildStudentClassAssignmentQuery) {
            return $criteria;
        }
        $query = new ChildStudentClassAssignmentQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildStudentClassAssignment A model object, or null if the key is not found
     */
    ...
    public function filterByStudentid($studentid = null, $comparison = null)
    {
        if (is_array($studentid)) {
            ...
            if (isset($studentid['min'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_STUDENTID, $studentid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($studentid['max'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_STUDENTID, $studentid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StudentClassAssignmentTableMap::COL_STUDENTID, $studentid, $comparison);
    }
    ...
    public function filterByClassid($classid = null, $comparison = null)
    {
        if (is_array($classid)) {
            ...
            if (isset($classid['min'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_CLASSID, $classid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($classid['max'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_CLASSID, $classid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StudentClassAssignmentTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(StudentClassAssignmentTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByStudent($student, $comparison = null)
    {
        if ($student instanceof \Student) {
            return $this
                ->addUsingAlias(StudentClassAssignmentTableMap::COL_STUDENTID, $student->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(StudentClassAssignmentTableMap::COL_STUDENTID, $student->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByKumi($kumi, $comparison = null)
    {
        if ($kumi instanceof \Kumi) {
            return $this
                ->addUsingAlias(StudentClassAssignmentTableMap::COL_CLASSID, $kumi->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(StudentClassAssignmentTableMap::COL_CLASSID, $kumi->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            StudentClassAssignmentTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(StudentClassAssignmentTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            StudentClassAssignmentTableMap::removeInstanceFromPool($criteria);
    ...
    {
        return $this->addUsingAlias(StudentClassAssignmentTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(StudentClassAssignmentTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(StudentClassAssignmentTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(StudentClassAssignmentTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(StudentClassAssignmentTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(StudentClassAssignmentTableMap::COL_CREATED_AT);
    }

} // StudentClassAssignmentQuery
