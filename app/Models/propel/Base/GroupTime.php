...
/**
 * Base class that represents a row from the 'time_group' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class GroupTime implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\GroupTimeTableMap';
    ...
    /**
     * Initializes internal state of Base\GroupTime object.
     */
    ...
    /**
     * Compares this with another <code>GroupTime</code> instance.  If
     * <code>obj</code> is an instance of <code>GroupTime</code>, delegates to
     * <code>equals(GroupTime)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GroupTime The current object, for fluid interface
     */
    ...
    public function setExamid($v)
    {
        ...
        if ($this->examid !== $v) {
            $this->examid = $v;
            $this->modifiedColumns[GroupTimeTableMap::COL_EXAMID] = true;
        }
    ...
    public function setGroupid($v)
    {
        ...
        if ($this->groupid !== $v) {
            $this->groupid = $v;
            $this->modifiedColumns[GroupTimeTableMap::COL_GROUPID] = true;
        }
    ...
    public function setSeconds($v)
    {
        ...
        if ($this->seconds !== $v) {
            $this->seconds = $v;
            $this->modifiedColumns[GroupTimeTableMap::COL_SECONDS] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[GroupTimeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[GroupTimeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupTimeTableMap::translateFieldName('Examid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->examid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupTimeTableMap::translateFieldName('Groupid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGroupTimeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GroupTime::setDeleted()
     * @see GroupTime::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGroupTimeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(GroupTimeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(GroupTimeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                GroupTimeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GroupTimeTableMap::COL_EXAMID)) {
            $modifiedColumns[':p' . $index++]  = 'examID';
        }
        if ($this->isColumnModified(GroupTimeTableMap::COL_GROUPID)) {
        ...
        $sql = sprintf(
            'INSERT INTO time_group (%s) VALUES (%s)',
    ...
    {
        $pos = GroupTimeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GroupTime'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GroupTime'][$this->hashCode()] = true;
        $keys = GroupTimeTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupTimeTableMap::COL_UPDATED_AT)) {
            $criteria->add(GroupTimeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GroupTime (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GroupTime Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(GroupTimeTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildGroupTime The current object (for fluent API support)
     */
