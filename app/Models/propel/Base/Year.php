...
/**
 * Base class that represents a row from the 'r_years' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Year implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\YearTableMap';
    ...
    /**
     * Initializes internal state of Base\Year object.
     */
    ...
    /**
     * Compares this with another <code>Year</code> instance.  If
     * <code>obj</code> is an instance of <code>Year</code>, delegates to
     * <code>equals(Year)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Year The current object, for fluid interface
     */
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[YearTableMap::COL_CONTENT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[YearTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[YearTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildYearQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildYearQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(YearTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(YearTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                YearTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO r_years (%s) VALUES (%s)',
    ...
    {
        $pos = YearTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Year'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Year'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(YearTableMap::COL_UPDATED_AT)) {
            $criteria->add(YearTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildYearQuery::create();
        $criteria->add(YearTableMap::COL_CONTENT, $this->content);
    ...
    /**
     * Generic method to set the primary key (content column).
     *
     ...
     * If this ChildYear is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildYear The current object (for fluent API support)
     */
    ...
    {
        return (string) $this->exportTo(YearTableMap::DEFAULT_STRING_FORMAT);
    }
