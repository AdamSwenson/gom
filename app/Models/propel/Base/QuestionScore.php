...
/**
 * Base class that represents a row from the 'questionScores' table.
 *
 *
 *
...
abstract class QuestionScore implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\QuestionScoreTableMap';
    ...
    /**
     * The value for the questionscore field.
     * @var        double
     */
    ...
    /**
     * Initializes internal state of Base\QuestionScore object.
     */
    ...
    /**
     * Compares this with another <code>QuestionScore</code> instance.  If
     * <code>obj</code> is an instance of <code>QuestionScore</code>, delegates to
     * <code>equals(QuestionScore)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|QuestionScore The current object, for fluid interface
     */
    ...
    /**
     * Get the [questionscore] column value.
     *
     * @return double
     */
    ...
    public function setExamid($v)
    {
        ...
        if ($this->examid !== $v) {
            $this->examid = $v;
            $this->modifiedColumns[QuestionScoreTableMap::COL_EXAMID] = true;
        }
    ...
    public function setQuestionid($v)
    {
        ...
        if ($this->questionid !== $v) {
            $this->questionid = $v;
            $this->modifiedColumns[QuestionScoreTableMap::COL_QUESTIONID] = true;
        }
    ...
    public function setStudentid($v)
    {
        ...
        if ($this->studentid !== $v) {
            $this->studentid = $v;
            $this->modifiedColumns[QuestionScoreTableMap::COL_STUDENTID] = true;
        }
    ...
    /**
     * Set the value of [questionscore] column.
     *
     * @param double $v new value
     * @return $this|\QuestionScore The current object (for fluent API support)
     */
    public function setQuestionscore($v)
    {
        if ($v !== null) {
            $v = (double) $v;
        }

        if ($this->questionscore !== $v) {
            $this->questionscore = $v;
            $this->modifiedColumns[QuestionScoreTableMap::COL_QUESTIONSCORE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[QuestionScoreTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[QuestionScoreTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : QuestionScoreTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : QuestionScoreTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : QuestionScoreTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 7; // 7 = QuestionScoreTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildQuestionScoreQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see QuestionScore::setDeleted()
     * @see QuestionScore::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildQuestionScoreQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(QuestionScoreTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(QuestionScoreTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                QuestionScoreTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(QuestionScoreTableMap::COL_QUESTIONID)) {
            $modifiedColumns[':p' . $index++]  = 'questionID';
        }
        if ($this->isColumnModified(QuestionScoreTableMap::COL_STUDENTID)) {
        ...
        $sql = sprintf(
            'INSERT INTO questionScores (%s) VALUES (%s)',
    ...
    {
        $pos = QuestionScoreTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['QuestionScore'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuestionScoreTableMap::COL_UPDATED_AT)) {
            $criteria->add(QuestionScoreTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function hashCode()
    {
        ...
        //relation questionScores_fk_71c1fe to table exams
        ...
        //relation questionScores_fk_175030 to table students
        ...
        //relation questionScores_fk_048855 to table questions
     ...
     * objects.
     *
     * @param      object $copyObj An object of \QuestionScore (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \QuestionScore Clone of current object.
     * @throws PropelException
     */
    ...
    public function getExam(ConnectionInterface $con = null)
    {
        if ($this->aExam === null && ($this->examid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aExam->addQuestionScores($this);
             */
        }
    ...
    public function getStudent(ConnectionInterface $con = null)
    {
        if ($this->aStudent === null && ($this->studentid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStudent->addQuestionScores($this);
             */
        }
    ...
    public function getQuestion(ConnectionInterface $con = null)
    {
        if ($this->aQuestion === null && ($this->questionid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aQuestion->addQuestionScores($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aStudent) {
            $this->aStudent->removeQuestionScore($this);
        }
        if (null !== $this->aQuestion) {
    ...
    {
        return (string) $this->exportTo(QuestionScoreTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildQuestionScore The current object (for fluent API support)
     */
