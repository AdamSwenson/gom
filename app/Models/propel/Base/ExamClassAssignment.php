...
abstract class ExamClassAssignment implements ActiveRecordInterface
{
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[ExamClassAssignmentTableMap::COL_USER_ID] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ExamClassAssignmentTableMap::COL_USER_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExamClassAssignmentTableMap::COL_USER_ID)) {
            $criteria->add(ExamClassAssignmentTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(ExamClassAssignmentTableMap::COL_CREATED_AT)) {
