...
/**
 * Base class that represents a row from the 'questionAssigner' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class QuestionAssigner implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\QuestionAssignerTableMap';
    ...
    /**
     * The value for the questionnumber field.
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Base\QuestionAssigner object.
     */
    ...
    /**
     * Compares this with another <code>QuestionAssigner</code> instance.  If
     * <code>obj</code> is an instance of <code>QuestionAssigner</code>, delegates to
     * <code>equals(QuestionAssigner)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|QuestionAssigner The current object, for fluid interface
     */
    ...
    /**
     * Get the [questionnumber] column value.
     *
     * @return int
     */
    ...
    public function setExamid($v)
    {
        ...
        if ($this->examid !== $v) {
            $this->examid = $v;
            $this->modifiedColumns[QuestionAssignerTableMap::COL_EXAMID] = true;
        }
    ...
    /**
     * Set the value of [questionnumber] column.
     *
     * @param int $v new value
     * @return $this|\QuestionAssigner The current object (for fluent API support)
     */
    public function setQuestionnumber($v)
    {
        ...
        if ($this->questionnumber !== $v) {
            $this->questionnumber = $v;
            $this->modifiedColumns[QuestionAssignerTableMap::COL_QUESTIONNUMBER] = true;
        }
    ...
    public function setQuestionid($v)
    {
        ...
        if ($this->questionid !== $v) {
            $this->questionid = $v;
            $this->modifiedColumns[QuestionAssignerTableMap::COL_QUESTIONID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[QuestionAssignerTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[QuestionAssignerTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : QuestionAssignerTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : QuestionAssignerTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = QuestionAssignerTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildQuestionAssignerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see QuestionAssigner::setDeleted()
     * @see QuestionAssigner::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildQuestionAssignerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(QuestionAssignerTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(QuestionAssignerTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(QuestionAssignerTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                QuestionAssignerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO questionAssigner (%s) VALUES (%s)',
    ...
    {
        $pos = QuestionAssignerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['QuestionAssigner'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuestionAssignerTableMap::COL_CREATED_AT)) {
            $criteria->add(QuestionAssignerTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(QuestionAssignerTableMap::COL_UPDATED_AT)) {
            $criteria->add(QuestionAssignerTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \QuestionAssigner (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \QuestionAssigner Clone of current object.
     * @throws PropelException
     */
    ...
    public function getExam(ConnectionInterface $con = null)
    {
        if ($this->aExam === null && ($this->examid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aExam->addQuestionAssigners($this);
             */
        }
    ...
    public function getQuestion(ConnectionInterface $con = null)
    {
        if ($this->aQuestion === null && ($this->questionid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aQuestion->addQuestionAssigners($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aExam) {
            $this->aExam->removeQuestionAssigner($this);
        }
        if (null !== $this->aQuestion) {
    ...
    {
        return (string) $this->exportTo(QuestionAssignerTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildQuestionAssigner The current object (for fluent API support)
     */
