...
/**
 * Base class that represents a query for the 'elementScores' table.
 *
 *
 *
 * @method     ChildElementScoreQuery orderByExamid($order = Criteria::ASC) Order by the examID column
 ...
 *
 * @method     ChildElementScoreQuery groupByExamid() Group by the examID column
 ...
 * @method     ChildElementScoreQuery innerJoinExam($relationAlias = null) Adds a INNER JOIN clause to the query using the Exam relation
 *
 * @method     ChildElementScoreQuery leftJoinElement($relationAlias = null) Adds a LEFT JOIN clause to the query using the Element relation
 * @method     ChildElementScoreQuery rightJoinElement($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Element relation
 * @method     ChildElementScoreQuery innerJoinElement($relationAlias = null) Adds a INNER JOIN clause to the query using the Element relation
 *
 * @method     ChildElementScoreQuery leftJoinStudent($relationAlias = null) Adds a LEFT JOIN clause to the query using the Student relation
 ...
 *
 * @method     \ExamQuery|\ElementQuery|\StudentQuery|\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildElementScore findOneByExamid(int $examID) Return the first ChildElementScore filtered by the examID column
 ...
 * @method     ChildElementScore requirePk($key, ConnectionInterface $con = null) Return the ChildElementScore by primary key and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildElementScore requireOne(ConnectionInterface $con = null) Return the first ChildElementScore matching the query and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildElementScore requireOneByExamid(int $examID) Return the first ChildElementScore filtered by the examID column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildElementScore[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildElementScore objects based on current ModelCriteria
 * @method     ChildElementScore[]|ObjectCollection findByExamid(int $examID) Return ChildElementScore objects filtered by the examID column
 ...
 *
 */
abstract class ElementScoreQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \Base\ElementScoreQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'gom', $modelName = '\\ElementScore', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildElementScoreQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildElementScoreQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildElementScoreQuery) {
            return $criteria;
        }
        $query = new ChildElementScoreQuery();
        if (null !== $modelAlias) {
     ...
     * </code>
     *
     * @param array[$examID, $elementID, $studentID] $key Primary key to use for the query
     * @param ConnectionInterface $con an optional connection object
     *
     * @return ChildElementScore|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ElementScoreTableMap::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1], (string) $key[2]))))) && !$this->formatter) {
            // the object is already in the instance pool
            return $obj;
        }
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(ElementScoreTableMap::DATABASE_NAME);
        }
     ...
     *
     * @return ChildElementScore A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        $sql = 'SELECT examID, elementID, studentID, user_id, elementScore, created_at, updated_at FROM elementScores WHERE examID = :p0 AND elementID = :p1 AND studentID = :p2';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildElementScore $obj */
            $obj = new ChildElementScore();
            $obj->hydrate($row);
            ElementScoreTableMap::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1], (string) $key[2])));
        }
        $stmt->closeCursor();
    ...
    {
        $this->addUsingAlias(ElementScoreTableMap::COL_EXAMID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTID, $key[1], Criteria::EQUAL);
        $this->addUsingAlias(ElementScoreTableMap::COL_STUDENTID, $key[2], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(ElementScoreTableMap::COL_EXAMID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(ElementScoreTableMap::COL_ELEMENTID, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $cton2 = $this->getNewCriterion(ElementScoreTableMap::COL_STUDENTID, $key[2], Criteria::EQUAL);
            $cton0->addAnd($cton2);
            $this->addOr($cton0);
        }
    ...
    public function filterByExamid($examid = null, $comparison = null)
    {
        if (is_array($examid)) {
            $useMinMax = false;
            if (isset($examid['min'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_EXAMID, $examid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($examid['max'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_EXAMID, $examid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ElementScoreTableMap::COL_EXAMID, $examid, $comparison);
    }
    ...
    public function filterByElementid($elementid = null, $comparison = null)
    {
        if (is_array($elementid)) {
            ...
            if (isset($elementid['min'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTID, $elementid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($elementid['max'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTID, $elementid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTID, $elementid, $comparison);
    }
    ...
    public function filterByStudentid($studentid = null, $comparison = null)
    {
        if (is_array($studentid)) {
            ...
            if (isset($studentid['min'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_STUDENTID, $studentid['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($studentid['max'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_STUDENTID, $studentid['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ElementScoreTableMap::COL_STUDENTID, $studentid, $comparison);
    }
    ...
    /**
     * Filter the query on the elementScore column
     *
     * Example usage:
     * <code>
     * $query->filterByElementscore(1234); // WHERE elementScore = 1234
     * $query->filterByElementscore(array(12, 34)); // WHERE elementScore IN (12, 34)
     * $query->filterByElementscore(array('min' => 12)); // WHERE elementScore > 12
     * </code>
     *
     * @param     mixed $elementscore The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return $this|ChildElementScoreQuery The current query, for fluid interface
     */
    public function filterByElementscore($elementscore = null, $comparison = null)
    {
        if (is_array($elementscore)) {
            $useMinMax = false;
            if (isset($elementscore['min'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTSCORE, $elementscore['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($elementscore['max'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTSCORE, $elementscore['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ElementScoreTableMap::COL_ELEMENTSCORE, $elementscore, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ElementScoreTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(ElementScoreTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByExam($exam, $comparison = null)
    {
        if ($exam instanceof \Exam) {
            return $this
                ->addUsingAlias(ElementScoreTableMap::COL_EXAMID, $exam->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ElementScoreTableMap::COL_EXAMID, $exam->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByElement($element, $comparison = null)
    {
        if ($element instanceof \Element) {
            return $this
                ->addUsingAlias(ElementScoreTableMap::COL_ELEMENTID, $element->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ElementScoreTableMap::COL_ELEMENTID, $element->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByStudent($student, $comparison = null)
    {
        if ($student instanceof \Student) {
            return $this
                ->addUsingAlias(ElementScoreTableMap::COL_STUDENTID, $student->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ElementScoreTableMap::COL_STUDENTID, $student->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildElementScore $elementScore Object to remove from the list of results
     *
     * @return $this|ChildElementScoreQuery The current query, for fluid interface
     */
    public function prune($elementScore = null)
    {
        if ($elementScore) {
            $this->addCond('pruneCond0', $this->getAliasedColName(ElementScoreTableMap::COL_EXAMID), $elementScore->getExamid(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(ElementScoreTableMap::COL_ELEMENTID), $elementScore->getElementid(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond2', $this->getAliasedColName(ElementScoreTableMap::COL_STUDENTID), $elementScore->getStudentid(), Criteria::NOT_EQUAL);
    ...
    /**
     * Deletes all rows from the elementScores table.
     *
    ...
    {
        if (null === $con) {
            $con = Propel::getServiceContainer()->getWriteConnection(ElementScoreTableMap::DATABASE_NAME);
        }
        ...
        return $con->transaction(function () use ($con) {
            ...
            ElementScoreTableMap::clearInstancePool();
            ElementScoreTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(ElementScoreTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            ElementScoreTableMap::removeInstanceFromPool($criteria);
    ...
    {
        return $this->addUsingAlias(ElementScoreTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ElementScoreTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ElementScoreTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(ElementScoreTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(ElementScoreTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(ElementScoreTableMap::COL_CREATED_AT);
    }
