...
*/
abstract class Element implements ActiveRecordInterface, IElement, \ObjectInterfaces\IElement
{
    /**
     * TableMap class name
     */
    ...
    /**
     * The value for the elementname field.
     * @var        string
     */
    protected $elementname;

    /**
     * The value for the displaytext field.
     * @var        string
     */
    protected $displaytext;

    /**
     * The value for the commenttext field.
     * @var        string
     */
    ...
    public function setElementname($v)
    {
        ...
        if ($this->elementname !== $v) {
            $this->elementname = $v;
            $this->modifiedColumns[ElementTableMap::COL_ELEMENTNAME] = true;
        }
    ...
    public function setDisplaytext($v)
    {
        ...
        if ($this->displaytext !== $v) {
            $this->displaytext = $v;
            $this->modifiedColumns[ElementTableMap::COL_DISPLAYTEXT] = true;
        }
    ...
    public function setCommenttext($v)
    {
        ...
        if ($this->commenttext !== $v) {
            $this->commenttext = $v;
            $this->modifiedColumns[ElementTableMap::COL_COMMENTTEXT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ElementTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ElementTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ElementTableMap::translateFieldName('Elementname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->elementname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ElementTableMap::translateFieldName('Displaytext', TableMap::TYPE_PHPNAME, $indexType)];
            $this->displaytext = (null !== $col) ? (string) $col : null;
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ElementTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ElementTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ElementTableMap::COL_ELEMENTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'elementName';
        }
        if ($this->isColumnModified(ElementTableMap::COL_DISPLAYTEXT)) {
            $modifiedColumns[':p' . $index++]  = 'displayText';
        }
        ...
        $sql = sprintf(
            'INSERT INTO elements (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'elementName':
                        $stmt->bindValue($identifier, $this->elementname, PDO::PARAM_STR);
                        break;
                    case 'displayText':
                        $stmt->bindValue($identifier, $this->displaytext, PDO::PARAM_STR);
                        break;
                    case 'commentText':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setElementname($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setDisplaytext($arr[$keys[2]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ElementTableMap::COL_ELEMENTNAME)) {
            $criteria->add(ElementTableMap::COL_ELEMENTNAME, $this->elementname);
        }
        if ($this->isColumnModified(ElementTableMap::COL_DISPLAYTEXT)) {
            $criteria->add(ElementTableMap::COL_DISPLAYTEXT, $this->displaytext);
        }
        if ($this->isColumnModified(ElementTableMap::COL_COMMENTTEXT)) {
        ...
        if ($this->isColumnModified(ElementTableMap::COL_UPDATED_AT)) {
            $criteria->add(ElementTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function setElementScores(Collection $elementScores, ConnectionInterface $con = null)
    {
        ...
        foreach ($elementScoresToDelete as $elementScoreRemoved) {
            $elementScoreRemoved->setElement(null);
        }
