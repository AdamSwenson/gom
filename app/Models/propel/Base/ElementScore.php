...
/**
 * Base class that represents a row from the 'elementScores' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class ElementScore implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ElementScoreTableMap';
    ...
    /**
     * Initializes internal state of Base\ElementScore object.
     */
    ...
    /**
     * Compares this with another <code>ElementScore</code> instance.  If
     * <code>obj</code> is an instance of <code>ElementScore</code>, delegates to
     * <code>equals(ElementScore)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ElementScore The current object, for fluid interface
     */
    ...
    public function setExamid($v)
    {
        ...
        if ($this->examid !== $v) {
            $this->examid = $v;
            $this->modifiedColumns[ElementScoreTableMap::COL_EXAMID] = true;
        }
    ...
    public function setElementid($v)
    {
        ...
        if ($this->elementid !== $v) {
            $this->elementid = $v;
            $this->modifiedColumns[ElementScoreTableMap::COL_ELEMENTID] = true;
        }
    ...
    public function setStudentid($v)
    {
        ...
        if ($this->studentid !== $v) {
            $this->studentid = $v;
            $this->modifiedColumns[ElementScoreTableMap::COL_STUDENTID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ElementScoreTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ElementScoreTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ElementScoreTableMap::translateFieldName('Examid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->examid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ElementScoreTableMap::translateFieldName('Elementid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ElementScoreTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ElementScoreTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = ElementScoreTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ElementScore'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildElementScoreQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ElementScore::setDeleted()
     * @see ElementScore::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildElementScoreQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ElementScoreTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ElementScoreTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ElementScoreTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ElementScoreTableMap::COL_EXAMID)) {
            $modifiedColumns[':p' . $index++]  = 'examID';
        }
        if ($this->isColumnModified(ElementScoreTableMap::COL_ELEMENTID)) {
        ...
        $sql = sprintf(
            'INSERT INTO elementScores (%s) VALUES (%s)',
    ...
    {
        $pos = ElementScoreTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ElementScore'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ElementScore'][$this->hashCode()] = true;
        $keys = ElementScoreTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ElementScoreTableMap::COL_EXAMID)) {
            $criteria->add(ElementScoreTableMap::COL_EXAMID, $this->examid);
        }
        if ($this->isColumnModified(ElementScoreTableMap::COL_ELEMENTID)) {
            $criteria->add(ElementScoreTableMap::COL_ELEMENTID, $this->elementid);
        }
        if ($this->isColumnModified(ElementScoreTableMap::COL_STUDENTID)) {
        ...
        if ($this->isColumnModified(ElementScoreTableMap::COL_UPDATED_AT)) {
            $criteria->add(ElementScoreTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildElementScoreQuery::create();
        $criteria->add(ElementScoreTableMap::COL_EXAMID, $this->examid);
        $criteria->add(ElementScoreTableMap::COL_ELEMENTID, $this->elementid);
        $criteria->add(ElementScoreTableMap::COL_STUDENTID, $this->studentid);
    ...
    public function hashCode()
    {
        ...
        //relation elementScores_fk_71c1fe to table exams
        ...
        //relation elementScores_fk_fd5216 to table elements
        if ($this->aElement && $hash = spl_object_hash($this->aElement)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation elementScores_fk_175030 to table students
    ...
    {
        return (null === $this->getExamid()) && (null === $this->getElementid()) && (null === $this->getStudentid());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ElementScore (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ElementScore Clone of current object.
     * @throws PropelException
     */
    ...
    public function getExam(ConnectionInterface $con = null)
    {
        if ($this->aExam === null && ($this->examid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aExam->addElementScores($this);
             */
        }
    ...
    public function getElement(ConnectionInterface $con = null)
    {
        if ($this->aElement === null && ($this->elementid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aElement->addElementScores($this);
             */
        }
    ...
    public function getStudent(ConnectionInterface $con = null)
    {
        if ($this->aStudent === null && ($this->studentid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStudent->addElementScores($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aElement) {
            $this->aElement->removeElementScore($this);
        }
        if (null !== $this->aStudent) {
    ...
    {
        return (string) $this->exportTo(ElementScoreTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildElementScore The current object (for fluent API support)
     */
