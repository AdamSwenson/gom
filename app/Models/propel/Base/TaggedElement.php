...
/**
 * Base class that represents a row from the 'tagsXelements' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class TaggedElement implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TaggedElementTableMap';
    ...
    /**
     * Initializes internal state of Base\TaggedElement object.
     */
    ...
    /**
     * Compares this with another <code>TaggedElement</code> instance.  If
     * <code>obj</code> is an instance of <code>TaggedElement</code>, delegates to
     * <code>equals(TaggedElement)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|TaggedElement The current object, for fluid interface
     */
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[TaggedElementTableMap::COL_TAG_ID] = true;
        }
    ...
    public function setElementId($v)
    {
        ...
        if ($this->element_id !== $v) {
            $this->element_id = $v;
            $this->modifiedColumns[TaggedElementTableMap::COL_ELEMENT_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TaggedElementTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[TaggedElementTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TaggedElementTableMap::translateFieldName('TagId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTaggedElementQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see TaggedElement::setDeleted()
     * @see TaggedElement::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTaggedElementQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TaggedElementTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TaggedElementTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                TaggedElementTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TaggedElementTableMap::COL_TAG_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO tagsXelements (%s) VALUES (%s)',
    ...
    {
        $pos = TaggedElementTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['TaggedElement'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TaggedElement'][$this->hashCode()] = true;
        $keys = TaggedElementTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaggedElementTableMap::COL_UPDATED_AT)) {
            $criteria->add(TaggedElementTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    public function hashCode()
    {
        ...
        //relation tagsXelements_fk_88cff7 to table elements
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TaggedElement (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TaggedElement Clone of current object.
     * @throws PropelException
     */
    ...
    public function getTag(ConnectionInterface $con = null)
    {
        if ($this->aTag === null && ($this->tag_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTag->addTaggedElements($this);
             */
        }
    ...
    public function getElement(ConnectionInterface $con = null)
    {
        if ($this->aElement === null && ($this->element_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aElement->addTaggedElements($this);
             */
        }
    ...
    public function clear()
    {
        ...
        if (null !== $this->aElement) {
            $this->aElement->removeTaggedElement($this);
        }
        $this->tag_id = null;
    ...
    {
        return (string) $this->exportTo(TaggedElementTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildTaggedElement The current object (for fluent API support)
     */
