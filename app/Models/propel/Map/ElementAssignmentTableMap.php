...
class ElementAssignmentTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Examid', 'Questionid', 'Subtask', 'Elementid', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('examid', 'questionid', 'subtask', 'elementid', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ElementAssignmentTableMap::COL_EXAMID, ElementAssignmentTableMap::COL_QUESTIONID, ElementAssignmentTableMap::COL_SUBTASK, ElementAssignmentTableMap::COL_ELEMENTID, ElementAssignmentTableMap::COL_CREATED_AT, ElementAssignmentTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('examID', 'questionID', 'subtask', 'elementID', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Examid' => 0, 'Questionid' => 1, 'Subtask' => 2, 'Elementid' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('examid' => 0, 'questionid' => 1, 'subtask' => 2, 'elementid' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(ElementAssignmentTableMap::COL_EXAMID => 0, ElementAssignmentTableMap::COL_QUESTIONID => 1, ElementAssignmentTableMap::COL_SUBTASK => 2, ElementAssignmentTableMap::COL_ELEMENTID => 3, ElementAssignmentTableMap::COL_CREATED_AT => 4, ElementAssignmentTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('examID' => 0, 'questionID' => 1, 'subtask' => 2, 'elementID' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
