...
class TagTableMap extends TableMap
{
     ...
     */
    const COL_USER_ID = 'tags.user_id';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'tags.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'tags.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Tag', 'UserId', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'tag', 'userId', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID, TagTableMap::COL_TAG, TagTableMap::COL_USER_ID, TagTableMap::COL_CREATED_AT, TagTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'tag', 'user_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Tag' => 1, 'UserId' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'tag' => 1, 'userId' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID => 0, TagTableMap::COL_TAG => 1, TagTableMap::COL_USER_ID => 2, TagTableMap::COL_CREATED_AT => 3, TagTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'tag' => 1, 'user_id' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('tag', 'Tag', 'VARCHAR', true, 225, null);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('TaggedQuestion', '\\TaggedQuestion', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':tag_id',
    1 => ':id',
  ),
), null, null, 'TaggedQuestions', false);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Question', '\\Question', RelationMap::MANY_TO_MANY, array(), null, null, 'Questions');
        $this->addRelation('User', '\\User', RelationMap::MANY_TO_MANY, array(), null, null, 'Users');
        $this->addRelation('Element', '\\Element', RelationMap::MANY_TO_MANY, array(), null, null, 'Elements');
    } // buildRelations()
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)]));
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TagTableMap::COL_TAG);
            $criteria->addSelectColumn(TagTableMap::COL_USER_ID);
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(TagTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(TagTableMap::COL_USER_ID, $value[1]));
