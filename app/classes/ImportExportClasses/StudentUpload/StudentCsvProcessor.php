...
class StudentCsvProcessor implements IStudentCsvProcessor
{
    ...
    /** @var $validator \ImportExportClasses\StudentImportValidator */
    public $validator;

    /** @var $importer \ImportExportClasses\StudentImporter */
    public $importer;
    
    /** @var $request \RequestClasses\IFileRequest */
    public $request;
    ...
    public function process_file(\RequestClasses\IFileRequest $request)
    {
        try {
            ...
            $file = \fopen($request->filenames[0], "r");
            $i = 0;
