...
VALUES
	...
	(9,1,7,'0','Any abstract discussion needs at least one good concrete example. In distinguishing between genuine tragedies of the commons and other kinds of situations, the details can be very important. You didn\'t do this. Thus your description of the cases had trouble clearly distinguishing between tragedy of the commons cases and ordinary cases in which, for example, many small harms add up, or where widespread irresponsibility or selfishness harm everyone. It can be a bit tricky to choose examples which do what I\'m looking for here. So if you have any questions about what was needed, please come talk to me. This will be important on the next exam1.','0000-00-00 00:00:00','0000-00-00 00:00:00'),
	(10,1,7,'1','Any abstract discussion needs at least one concrete example. In distinguishing between genuine tragedies of the commons and other kinds of situations, the details can be very important. Your example didn\'t help distinguish tragedy of the commons cases from ordinary cases in which, for example, many small harms add up, or where widespread irresponsibility or selfishness harm everyone. It can be a bit tricky to explain examples in the way that I?m looking for. So if you have any questions about what was needed, please come talk to me. This will be important on the next exam1.','0000-00-00 00:00:00','0000-00-00 00:00:00'),
	...
	(24,1,3,'3','The tricky part of this question was giving a good example. Since the definition of moral hazard is precise, it is extremely important to give an example (with enough details) that exactly matches each part of the definition. Your execution of this task was amongst the best in the class! That is especially good since this approach to giving examples will be extremely important on parts of the next exam1.','0000-00-00 00:00:00','0000-00-00 00:00:00'),
	...
	(99,1,11,'3','We have a powerful natural tendency to think as though distance matters morally. We don\'t feel the same urgency and sympathy when we learn of someone who needs help on another continent as we do if they are right in front of us. It is not enough to just say that we should ignore this tendency. We need an argument to show demonstrate that it is a mistake. You recognized that and did a good job setting out the needed argument. I think that someone reading your answer would be convinced that distance does not matter.\rYou did a great job on this part. But you may have been a bit weak on some points (which is understandable on a timed exam1). So, for the record, here is pretty much everything that needed to be said: \rA common methodology in ethics for determining whether some fact affects our moral obligations (whether it matters morally) to use the contrasting cases method: Start with one case where we have clear beliefs about what should be done. Then imagine a series of cases where we change only one variable. If at the end of the series, we have the same beliefs about what should be done, then the variable did not matter morally.\rThe example we used in class was a baby drowning in a puddle. We are completely certain that someone standing right next to the baby should save it; if they don?t they are a horrible person. We then imagined some technology (the Baby Flipper 5000) which allows us to change the distance while holding constant the rescuer\'s ability to know that the child needs help and her ability to help. We increase the physical distance until the baby (with Baby Flipper standing by) is in Mongolia. Since we agree that the rescuer is exactly as required to save the baby in Mongolia via the Baby Flipper app as she was when the baby was right in front of her, we conclude that distance is not a moral consideration. That is, distance does not matter morally.\r','0000-00-00 00:00:00','0000-00-00 00:00:00'),
