...
var files = {
  ...
  '_e.scss': path.join(fixtures, 'components_help/_e.scss'),
  ...
  'k.l.scss': path.join(fixtures, 'components_help/k.l.scss'),
  'm.scss': path.join(fixtures, 'm.scss'),
  '_n.scss': path.join(fixtures, 'compass/_n.scss'),
  '_compass.scss': path.join(fixtures, 'components_help/_compass.scss')
}
...
describe('sass-graph', function(){
  ...
  describe('parsing a graph of all scss files', function(){
    var graph = sassGraph.parseDir(fixtures, {loadPaths: [fixtures + '/components_help']});
  ...
  describe('parseFile', function () {
    it('should parse imports with loadPaths', function () {
      var graph = sassGraph.parseFile(files['d.scss'], {loadPaths: [fixtures + '/components_help']} );
