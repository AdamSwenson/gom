...
module.exports = (function () {
  ...
  var compactShorthands = function(tokens, isImportant, processable, Token) {
    // Contains the components_help found so far, grouped by shorthand name
    var componentsSoFar = { };
    ...
    var compactSoFar = function (prop) {
      ...
      // Find components_help for the shorthand
      var components = [];
      var realComponents = [];
      ...
      if (realComponents.length === 0) {
        // Couldn't find enough components_help, sorry
        return false;
      }

      if (realComponents.length === componentsCount) {
        // When all the components_help are from real values, only allow shorthanding if their understandability allows it
      ...
      // Compact the components_help into a shorthand
      ...
      if (realComponents.length === componentsCount || compactedLength < authenticLength || components.some(isHackValue)) {
        ...
        // Mark the granular components_help for deletion
    ...
    // Go through each token and collect components_help for each shorthand as we go on
