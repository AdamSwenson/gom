...
module.exports = (function () {
  ...
  // Functions for breaking up shorthands to components_help
  var breakUp = {};
  breakUp.takeCareOfFourValues = function (splitfunc) {
    return function (token) {
      ...
      // Now break it up to its components_help
  ...
  // Contains functions that can put together shorthands from their components_help
  ...
  var putTogether = {
    ...
    fourUnits: function (prop, tokens, isImportant) {
      ...
      // 1-value short form: all four components_help are equal
    ...
    // Puts together the components_help by spaces and omits default values (this is the case for most shorthands)
    bySpacesOmitDefaults: function (prop, tokens, isImportant, meta) {
      ...
      // This will be the value of the shorthand if all the components_help are default
  ...
  // Possible options:
  //
  // * components_help: array (Only specify for shorthand properties.)
  ...
  //   For shorthand, this is used when every component is set to its default value, therefore it should be the shortest possible default value of all the components_help.
  //
  ...
  //   Breaks the shorthand up to its components_help.
  //
  // * putTogether: function (Only specify for shorthand properties.)
  //   Puts the shorthand together from its components_help.
  //
  var processable = {
    'color': {
