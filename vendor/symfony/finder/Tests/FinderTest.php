...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testIgnoreVCS($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', 'foo', 'foo/bar.tmp', 'test.blade.php', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testIgnoreDotFiles($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo', 'foo/bar.tmp', 'test.blade.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testIn($adapter)
    {
        ...
        $this->assertIterator(array(self::$tmpDir.DIRECTORY_SEPARATOR.'test.blade.php', __DIR__.DIRECTORY_SEPARATOR.'FinderTest.php', __DIR__.DIRECTORY_SEPARATOR.'GlobTest.php'), $iterator);
    }
    ...
    public function testMultipleLocations(Adapter\AdapterInterface $adapter)
    {
        ...
        $finder = $this->buildFinder($adapter);
        $finder->in($locations)->depth('< 1')->name('test.blade.php');
    ...
    public function testAdaptersChaining()
    {
        ...
        $filenames = $this->toAbsolute(array('foo', 'foo/bar.tmp', 'test.blade.php', 'test.py', 'toto'));
