...
export const Comments = {
    ...
    mutations: {
        loadElementComments( state, rootState, elementCommentsJSON ) {
         ...
         */
        loadStockComments( state, rootState, stockCommentsJSON ) {
         ...
         * @param commentText
         */
        storeCommentText( state, rootState, studentIndex, elementIndex, commentText ) {
         ...
         * @param commentText
         */
        storeCommentTextForActiveStudent( state, rootState, elementIndex, commentText ) {
