const config = {
    ...
    // baseURL: 'https://gradeomatic.net/api/',
    ...
    transformRequest: [ function ( data ) {
        ...
        window.console.log( 'axiosConfig', 'transformRequest', 18, data);
        return data;
    } ],
    ...
    transformResponse: [ function ( data ) {
        // Do whatever you want to transform the data
        window.console.log( 'axiosConfig', 'transformResponse', 26, data);
        return data;
    } ],
    ...
    onUploadProgress: function ( progressEvent ) {
        ...
        window.console.log( 'axiosConfig', 'onUploadProgress', 90, progressEvent);
    },

    // `onDownloadProgress` allows handling of progress events for downloads
    onDownloadProgress: function ( progressEvent ) {
        // Do whatever you want with the native progress event
        window.console.log( 'axiosConfig', 'onDownloadProgress', 95, progressEvent);
    },
