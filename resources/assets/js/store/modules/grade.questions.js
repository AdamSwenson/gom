...
const mutations = {
     ...
     * @param maxScores
     */
        [types.loadMaxQuestionScores](state, rootState, maxScores) {
     ...
     */
        [types.loadQuestions](state, rootState, questionsJson) {
    ...
    [types.loadNumberQuestions](state, rootState, numberQuestionsOnExam) {
