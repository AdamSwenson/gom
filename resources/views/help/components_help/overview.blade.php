    ...
    <div class="col-lg-6">
        <section id="{{\App\ViewTools\HelpLinks::$overviewProcess['id']}}" class="group">
            ...
            <dl class="dl-horizontal">
                ...
                <dd>Create the exam, prepare the questions, add raw material for
                    feedback,and upload students
                </dd>
                <dt><a href="#{{\App\ViewTools\HelpLinks::$instructSectionGrade['id']}}">Grade</a></dt>
                <dd>Evaluate student work and adjust the grade distribution
                </dd>
            ...
            <p class="answer">Of course, grading is a complex and organic process. So, you can generally jump around
                ...
                exams
                in.
                It's easy to add additional items for assessment and feedback mid-grading when your students discover a novel way to misunderstand a concept.
            </p>

            <p class="answer">while  <a
                        href="#{{\App\ViewTools\HelpLinks::$instructSectionGradeGrading['id']}}">reviewing student work</a>, you enter
                scores for each question and its subsidiary tasks. This automatically builds individualized feedback for each student. You may further customize each student's feedback by editing the automatically compiled text of the fly.</p>
            ...
            <p class="answer">With <a
                        href="{{\App\ViewTools\HelpLinks::$instructSectionReportFeedbackRelease['id']}}">two clicks</a> you can email each student a unique link to their feedback. This link allows each student
            ...
            <p class="answer">Once students have had enough time to review their feedback, you may remove access with another <a
                        href="#{{\App\ViewTools\HelpLinks::$instructSectionReportFeedbackRelease['id']}}">click</a>. You may also print out the feedback and hand it back to students. </p>
