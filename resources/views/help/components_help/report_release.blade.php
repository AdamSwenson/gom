...
<section id="{{\App\ViewTools\HelpLinks::$reportRelease['id']}}" class="group">
    ...
    <div class="row">
        <div class="col-lg-6">
            <p class="answer">
                Clicking "Release Exam" officially releases the exam1. This involves emailing unique links to all students who have been graded and who have valid email addresses. This link will all them to view their grade and feedback.
            </p>
        </div>
        <div class="col-lg-6">
            @include('help.partials.picture_container',
...
<section id="{{\App\ViewTools\HelpLinks::$reportLock['id']}}" class="group">
    ...
    <h4 class="text-center">Lock exam1</h4>
    <div class="row">
        <div class="col-lg-6">
            <p class="answer"> The lock is the reverse. Clicking Lock cuts off all access to all students for that exam1. Once an
                exam1 is locked, it must be released again. If a locked exam1 is re-released, students will receive a new email with a new link.</p>

            <p class="answer">Once an exam1 has been locked, any links that have been sent to students will not work. This can be
            ...
            <p class="answer">Once the exam1 is released, the release button changes color to green. This indicates that
