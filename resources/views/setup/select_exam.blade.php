 ...
 <div class="section">
  <div class="container">
   ...
   <div class="list-group">
    ...
    <div id="examListEdit" class="sublinks collapse">
     ...
     <div class="container">
         ...
         @foreach($exams as $exam)
          <div  class="row">
       <form method="GET" action="{{url('exam/'. $exam . '/edit')}}" accept-charset="UTF-8" class="col-xs-4">
        <div  class="col-lg-12">
             <button type="submit" name= "examid" value="{{ $exam }}" class="list-group-item small">{{ $exam }}</button>
         </div>
       </form>
           </div>
         @endforeach
    ...
    <a id="deleteExamLink" href="#" class="list-group-item" data-toggle="collapse" data-target="#examListDelete" data-parent="#examAction">
