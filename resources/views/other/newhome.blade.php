...
@section('body')
    ...
    <div class="row">
        <div class="col-md-5">
            <h3 class="text-center">Do this</h3>
        </div>
        <div class="col-md-6">
            <h3 class="text-center">Give your students this</h3>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="row">
                <div class="col-md-12">
                    <p class="text-left"><strong>Student name:</strong> Smith, Jane</p>

                    <p class="text-left"><strong>Grade:</strong> <span id="gradeSpot"></span></p>
                </div>
            </div>
