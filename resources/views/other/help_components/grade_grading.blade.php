...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">When you are done setting up the exam and ready to grade, click 'Grade' in the navigation bar
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">If you prefer to grade exams without knowing the students' names, click the pencil icon. </p>
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">You may also search for a student by clicking on the name or id display boxes at the top and
...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">The button marked 'Pause' or 'Start' manually starts and stops the timer. When you take a
            break, it's a good idea to click pause. Otherwise the timer will keep running for the last exam you graded.
...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">If you wish to tailor the student's feedback individually, modify the text box next to that
        ...
        <p class="answer">
            ...
            entered for that level of competence. If you did not customize the text for each degree of performance when
            you created the element, the text will not change as you move the slider. However, the score indicated by
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">
            Alternatively, you may select a letter grade from the dropdown menu. The gradeomatic will enter a percentage
...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">Once a grade is entered for at least one question, the student's exam is considered graded for
            timing and release purposes. This allows you to construct exams where students may choose among one or more
...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">
            Unlike the setup pages where no changes were saved until you moved to the next step, during grading, every
