...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">Elements comprise questions. On more complex questions, where you are asking the student to do
            multiple things or where explaining a concept requires several different components, each task or component
            should be represented by an element. </p>

        <p class="answer">Multi-part questions or short essays spanning several paragraphs might have several elements.
            While a short-form question might only have one. A question can have zero elements if you only want to use
            the gradeomatic for reporting scores.
        </p>

        <p class="answer">If you are familiar with using rubrics to grade an exam, you are already familiar with how to
        ...
        <div class="answer">Whatever you fill in for x, y, and z in that conversation are the elements of the question
        </div>
    </div>
    <div class="col-lg-6"></div>
</div>
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">You then also provide some text that will form the basis for all feedback that you give on the
            element.</p>
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">Iff you just wanted to give every student the same feedback regardless of how they do, you can
            stop here.</p>

        <p class="answer">However, pressing the "Customize Response" button allows you to further customize the text to
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">
            Here you modify that basic comment to tailor it based on the student's performance. By default, gradeomatic
            allows for four responses varieties: "missing", "poor", "fair" and "excellent". These responses will be what
        ...
        <blockquote><p>In order to say why Descartes has adopted the skeptical method of the Meditations, you need to
                tell the reader what Descartes is hoping to achieve. Namely, he is trying to discover what kinds of
                beliefs can be the completely certain foundations upon which the rest of our knowledge can be built.
                That is, the idea is to find some beliefs which he can't be wrong about. Then he can work backwards to
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <blockquote>
            <p>
                In order to say why Descartes has adopted the skeptical method of the Meditations, you need to tell the
                reader what Descartes is hoping to achieve.
                <ins> However, you didn't do this. This leaves it up to your reader to figure out that Descartes</ins>
                is trying to discover what kinds of beliefs can be the completely certain foundations upon which the
                rest of our knowledge can be built. That is, the idea is to find some beliefs which he can't be
                wrongabout. Then he can work backwards to explaining why and when, for example, scientific beliefs count
                as certain knowledge.
                <ins>As you can see, this is pretty complicated. So you can't just assume that the reader will figure it
                    out.
                </ins>
            </p>
        </blockquote>
...
<div class="row">
    <div class="col-lg-6">
        <h6>Poor</h6>
        <blockquote>
            <p>In order to say why Descartes has adopted the skeptical method of the Meditations, you need to tell the
                reader what Descartes is hoping to achieve.
                <ins>You tried to do this. But it was not clear from your answer that his goal is to</ins>
                discover what kinds of beliefs can be the completely certain foundations upon which the rest of our
                knowledge can be built. That is, the idea is to find some beliefs which he can't be wrong about. Then he
    ...
    <div class="col-lg-6">
        ...
        <blockquote>
            <p>
                ...
                is trying to discover what kinds of beliefs can be the completely certain foundations upon which the
                rest of our knowledge can be built. That is, the idea is to find some beliefs which he can't be wrong
                about. Then he can work backwards to explaining why and when, for example, scientific beliefs count as
                certain knowledge.
            </p>
        </blockquote>
    </div>
    ...
    <div class="col-lg-6">
        ...
        <blockquote>
            <p>
                ...
                in order to say why Descartes has adopted the skeptical method of the Meditations, the reader needed to
                ...
                is to find some beliefs which Descartes can't be wrong about.Then he can work backwards to explaining
...
<div class="row">
    <div class="col-lg-6">
        ...
        <blockquote>
            <p>You need to explain the role doubt plays in Descartes method. He is using a principle like "If I can find
                grounds for doubting that a kind of belief is true, then no beliefs of that sort count as knowledge".
                So, for example, if we're talking about beliefs based on seeing things in the distance, I might believe
                that I see a plane. But then someone points out that birds are often confused with faraway planes. Now I
                can't say that I know that object in the distance is a plane until I can be sure that it is not a bird.
            </p>
        </blockquote>
    </div>
    <div class="col-lg-6">
