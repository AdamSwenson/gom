...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">If you want to use the gradeomatic to assign grades, click the Assign button on the grade exam select page. </p>
    </div>
    <div class="col-lg-6">
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">The gradeomatic has calculated the maximum possible score on the exam from the maximum scores of each question. It then provides suggestions for the minimum total score necessary for each letter grade. </p>
        <p class="answer">To adjust the grade distribution, alter the values in the boxes. The accompanying charts will update to show the new distributions. </p>
    </div>
    <div class="col-lg-6">
        @include('other.help_components.picture_container',
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">If you don't want to use a letter, simply empty the box and it will not be a possible grade for students.</p>
    </div>
    <div class="col-lg-6">
        @include('other.help_components.picture_container',
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">The upper chart on the right-hand side of the page shows a histogram of the number of students currently receiving each grade.</p>
    </div>
    <div class="col-lg-6">
        @include('other.help_components.picture_container',
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">When assigning grades, it is often helpful to look for natural gaps in student scores. The bar chart on the lower  right-hand side of the page shows the total exam score each student along with the grade that they would receive under the present distribution.</p>

        <p class="answer">This chart preserves anonymity by giving each student a number. The number on the x axis identifies students ordered by total score from low to high. This number is unrelated to their student id number or the order in which they were graded.</p>
    </div>
    <div class="col-lg-6">
        @include('other.help_components.picture_container',
