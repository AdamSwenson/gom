<h4 class="text-center">Adding students</h4>
...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">The only required information is the first and last name of the student. You may also include
            the
            student's ID number (if, for example, you wish to grade the exams blindly) and their email address if you
            want
...
<h4 class="text-center">Importing students</h4>
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">A dialog will pop up allowing you to select the file to upload. Make sure you choose the file
            which ends in '.csv'</p>
    </div>
    <div class="col-lg-6">
        @include('other.help_components.picture_container',
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">Check over the imported records to make sure that everything is in the correct location</p>
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">The student has been set for deletion. The actual deletion will take place once the roster is
            saved</p>
    </div>
    <div class="col-lg-6">
        @include('other.help_components.picture_container',
