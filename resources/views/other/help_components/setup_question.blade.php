...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">If you want to give each question a letter grade and then have the overall exam grade reflect all questions equally,
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">Changing the order of questions is easy. Click on the 'Move' button for the question whose position you want to change.</p>
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">Once in position, release the button. The other questions will update their numbers accordingly.</p>
    </div>
    <div class="col-lg-6">
        <div class="figure">
            <p class="picture">
...
<div class="row">
    <div class="col-lg-6">
        <p class="answer">No changes to the questions are saved to the database until you click 'Add/Edit elements'.</p>
    </div>
    <div class="col-lg-6">
        <div class="figure">
            <p class="picture">
...
<div class="row">
    <div class="col-lg-6">
        ...
        <p class="answer">Once you confirm by clicking 'Delete' in the pop up, the question will disappear from
            the screen. However, the question is not deleted from the database until you click 'Add/Edit Elements'</p>

        <p class="answer">Please be very careful with deleting questions. If a question is deleted, all student scores for that
            question are removed from the database. Any elements associated with the question are also deleted, along with any
